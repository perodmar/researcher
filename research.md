...
<ol>
    ...
    <li>
        ...
        <li>
        <strong style="margin-bottom: 10px; display: block;">Crime-Differential Responses to an Environmental Shock: Evidence from Blackouts (with <a href="https://sites.google.com/site/pdomingr/">Patricio Dominguez</a>) [<a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4921694">Link</a>] [R&R at Economic Development and Cultural Change]</strong>
        <div style="display: flex; align-items: flex-start; margin-bottom: 15px;">
