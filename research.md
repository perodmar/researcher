...
<ol>
    ...
    <li>
        ...
        <li>
        <strong style="margin-bottom: 10px; display: block;">Crime-Differential Responses to an Environmental Shock: Evidence from Blackouts (with <a href="https://sites.google.com/site/pdomingr/">Patricio Dominguez</a>) [Link](files/RodriguezMartinez, Pedro - CV.pdf).</strong>
        <div style="display: flex; align-items: flex-start; margin-bottom: 15px;">
