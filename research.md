...
<ol>
    <li>
        <strong style="margin-bottom: 10px;">Crime-Differential Responses to an Environmental Shock: Evidence from Blackouts (with <a href="https://sites.google.com/site/pdomingr/">Patricio Dominguez</a>)</strong>
    ...
    <li>
        <strong style="margin-bottom: 10px;">Police-Monitored Cameras and Crime: Evidence from a Nationwide Policy (with <a href="https://sites.google.com/site/pdomingr/">Patricio Dominguez</a>)</strong>
        <div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
            <img src="photo.jpg" alt="Image description" style="width: 150px; margin-right: 15px;">
