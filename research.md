...
<strong style="margin-bottom: 5px; color:#0437F2; display: block;"> R&R at Economic Development and Cultural Change </strong>
        <div style="display: flex; align-items: flex-start; margin-bottom: 10px;">
            ...
            <br><br><strong><u>Presented:</u></strong> Development Tea @GWU.
      ...
      <li>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 10px;">
            ...
            <br><br><strong><u>Upcoming:</u></strong> APPAM Fall 2024 Research Conference. </small>
        </div>
    </li>
    <li>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 10px;">
            ...
            <br><br><strong><u>Presented:</u></strong> Virtual Crime Economics (ViCE) Seminar Series, Washington Area Development Economics Symposium (WADES), Applied Micro BB and Development Tea @GWU.
            <br><strong><u>Upcoming:</u></strong> SEA 94th Annual Meetings and APPAM Fall 2024 Research Conference. </small>
        </div>
    </li>
</ol>
