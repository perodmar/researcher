...
<ol>
    <li>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
            <img src="files/coefplot_housepop_buvsro.png" alt="Image description" style="width: 200px; margin-right: 15px;">
    ...
    <li>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
            <img src="files/grid_Tumbaco.jpg" alt="Image description" style="width: 200px; margin-right: 15px;">
    ...
    <li>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 20px;">
            <img src="files/are_Chicago.jpg" alt="Image description" style="width: 200px; margin-right: 15px;">
