...
<ol>
    ...
    <li>
        ...
        <div style="display: flex; align-items: flex-start; margin-bottom: 10px;">
            ...
            <br><br><strong>Presented:</strong> Virtual Crime Economics (ViCE) Seminar Series, Washington Area Development Economics Symposium (WADES), Applied Micro BB and Development Tea @GWU.
            <br><strong>Upcoming:</strong> SEA 94th Annual Meetings and APPAM Fall 2024 Research Conference. </small>
        </div>
    </li>
        <li>
        <strong style="margin-bottom: 5px; display: block;">Crime-Differential Responses to an Environmental Shock: Evidence from Blackouts (with <a href="https://sites.google.com/site/pdomingr/">Patricio Dominguez</a>) [<a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4921694">Link</a>]</strong> 
<strong style="color:#0047AB; display: block;"> R&R at Economic Development and Cultural Change </strong>
        <div style="display: flex; align-items: flex-start; margin-bottom: 10px;">
